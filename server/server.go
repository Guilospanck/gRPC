...
var (
	tls        = flag.Bool("tls", false, "Coonection uses TLS if true, else plain TCP")
...
func (s *routeGuideServer) RouteChat(stream pb.RouteGuide_RouteChatServer) error {
	for {
		...
		// This copy prevents blocking other clients while serving this one.
...
// Helper function to serialize coordinates into raw strings
...
func (s *routeGuideServer) loadFeatures(filePath string) {
	...
	// if there is a file defined in the args
	if filePath != "" {
		var err error
	...
	} else { // if there isn't, use default example data
		data = exampleData
	}
...
func main() {
	...
	// Specifies the port we want to listen for client requests
	...
	// calls Serve() on the server with our port details to do a blocking wait
